...
<img src="resources/chapter-4/sprint-2/insights-pulse.png" alt="" height="400">

<img src="assets/flutter_pulse.png" alt="" height="600">
<br>

**Contributors**

<img src="resources/chapter-4/sprint-2/insights-contributors.png" alt="" height="400">

<img src="assets/flutter_contributors.png" alt="" height="600">
...
<table>
  ...
  <tr>
    ...
    <td align="center">Reunión Virtual</td>
  </tr>
  <tr>
    <td align="center"><strong>Prepared By</strong></td>
    <td align="center">Yasser Rentería Palacios</td>
  </tr>
  <tr>
    <td align="center"><strong>Attendees</strong></td>
    <td align="center">Renzo Araujo Ingunza, Adrian Valerio García, Fabrizio Alexander Cutiri Agüero</td>
  </tr>
  <tr>
    <td align="center"><strong>Sprint 3 Review Summary</strong></td>
    <td align="center">Culminación total de la aplicación móvil en Flutter</td>
  </tr>
  <tr>
    <td align="center"><strong>Sprint 3 Retrospective Summary</strong></td>
    <td align="center">Cumplimos la meta de lanzar la versión completa del servicio web y la aplicación móvil para dispositivos Android.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center">Crear y publicar una aplicación móvil en Flutter que muestre de forma clara y visualmente atractiva los principales beneficios y características del producto, optimizada para su uso en dispositivos móviles.</td>
  </tr>
  <tr>
...
Para el Sprint N.° 3 nos planteamos como objetivo finalizar el desarrollo y realizar el despliegue de la aplicación móvil construida en Flutter.

<table border="1" cellspacing="0" cellpadding="5">
  <tr>
    <td colspan="9" align="center"><strong>Sprint 3 - Product Backlog</strong></td>
  </tr>
  <tr>
    <td align="center" width="7%"><strong>User Story ID</strong></td>
    <td align="center" width="13%"><strong>User Story</strong></td>
    <td align="center" width="7%"><strong>Task ID</strong></td>
    <td align="center" width="18%"><strong>Task Title</strong></td>
    <td align="center" width="22%"><strong>Description</strong></td>
    <td align="center" width="6%"><strong>Hours</strong></td>
    <td align="center" width="6%"><strong>SP</strong></td>
    <td align="center" width="12%"><strong>Assigned To</strong></td>
    <td align="center" width="9%"><strong>Status</strong></td>
  </tr>
  <tr>
    ...
    <td>Crear interfaz de registro en Flutter con campos de usuario y vehículo</td>
  ...
  <tr>
    ...
    <td>Desarrollar validaciones de datos y conexión con backend</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Crear interfaz de autenticación en Flutter</td>
    <td align="center">2</td>
    <td align="center">2</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  </tr>
  <tr>
    <td align="center">US21</td>
    ...
    <td>Integrar JWT y gestión de tokens en Flutter</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Implementar funcionalidad de logout</td>
    <td>Desarrollar cierre de sesión y limpieza de datos locales</td>
  ...
  <tr>
    ...
    <td>Diseñar pantalla de perfil</td>
    <td>Crear interfaz para completar perfil de usuario</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Implementar guardado de perfil</td>
    <td>Desarrollar lógica de almacenamiento en SharedPreferences</td>
    <td align="center">1</td>
    <td align="center">2</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Crear vista de edición de perfil</td>
    <td>Implementar interfaz para modificar información personal</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Integrar actualización de perfil</td>
    <td>Conectar con API para actualizar datos del usuario</td>
    <td align="center">1</td>
    <td align="center">2</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Diseñar pantalla de búsqueda</td>
    <td>Crear interfaz de búsqueda con filtros en Flutter</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Implementar lógica de búsqueda</td>
    <td>Desarrollar algoritmo de búsqueda y consumo de API</td>
    <td align="center">3</td>
  ...
  <tr>
    ...
    <td>Ver detalles de ruta</td>
    <td align="center">T12</td>
    <td>Diseñar vista de detalles de ruta</td>
    <td>Crear pantalla para mostrar información completa de rutas</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Integrar datos de ruta en detalles</td>
    <td>Conectar vista con endpoints del backend</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Ver paraderos en el mapa</td>
    <td align="center">T14</td>
    <td>Integrar Google Maps en Flutter</td>
    <td>Configurar y mostrar mapa con ubicaciones de paraderos</td>
    <td align="center">3</td>
    <td align="center">5</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Agregar marcadores de paraderos</td>
    <td>Implementar markers interactivos con información de paraderos</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Diseñar vista de conductor</td>
    <td>Crear interfaz para mostrar datos y calificaciones del conductor</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Integrar información del conductor</td>
    <td>Obtener datos del conductor desde el backend</td>
    <td align="center">1</td>
    <td align="center">2</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Filtrar paraderos</td>
    <td align="center">T18</td>
    <td>Diseñar filtros de paraderos</td>
    <td>Crear componentes de filtro por región, provincia, distrito</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Renzo Araujo</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Implementar filtrado de paraderos</td>
    <td>Desarrollar lógica de filtrado y actualización de resultados</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Renzo Araujo</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Activar disponibilidad de ruta</td>
    <td align="center">T20</td>
    <td>Crear toggle de disponibilidad</td>
    <td>Implementar control para activar/desactivar disponibilidad en Flutter</td>
    <td align="center">1</td>
    <td align="center">2</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Sincronizar estado en tiempo real</td>
    <td>Desarrollar actualización de estado en backend</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    <td align="center">SS01</td>
    <td>Integración Google Maps</td>
    <td align="center">T22</td>
    <td>Optimizar mapa para rutas</td>
    <td>Implementar polylines para mostrar rutas en el mapa</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Pruebas de funcionalidad de mapas</td>
    <td>Validar rendimiento y precisión de mapas</td>
    <td align="center">2</td>
    <td align="center">3</td>
    <td>Renzo Araujo</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Implementar CRUD de rutas en móvil</td>
    <td>Crear operaciones de crear, editar, eliminar rutas en Flutter</td>
    <td align="center">3</td>
    <td align="center">5</td>
    <td>Fabrizio Cutiri</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Gestión de paraderos</td>
    <td align="center">T25</td>
    <td>Implementar CRUD de paraderos en móvil</td>
    <td>Crear operaciones para gestionar paraderos en Flutter</td>
    <td align="center">3</td>
    <td align="center">5</td>
    <td>Renzo Araujo</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Optimizar navegación en Flutter</td>
    <td>Mejorar estructura de rutas y navegación entre pantallas</td>
    <td align="center">2</td>
    <td align="center">3</td>
  ...
  <tr>
    ...
    <td>Implementar bottom navigation</td>
    <td>Crear menú inferior para navegación principal</td>
    <td align="center">1</td>
    <td align="center">2</td>
    <td>Adrián Valerio</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Endpoints de autenticación</td>
    <td align="center">T28</td>
    <td>Validar endpoints de auth</td>
    <td>Asegurar que los endpoints de login y registro funcionen correctamente</td>
    <td align="center">1</td>
    <td align="center">2</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
  ...
  <tr>
    ...
    <td>Endpoints de usuarios</td>
    <td align="center">T29</td>
    <td>Validar endpoints de usuarios</td>
    <td>Verificar que los endpoints CRUD de usuarios funcionan en Flutter</td>
    <td align="center">1</td>
    <td align="center">2</td>
    <td>Yasser Rentería</td>
    <td align="center">Done</td>
...
<table border="1" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <td align="center"><strong>Commit Date</strong></td>
  </tr>

  <!-- Primer repositorio -->
  <tr>
    <td rowspan="3" align="center">https://github.com/Aplicaciones-Moviles-Grupo/ChapaTuRutaBackend</td>
    <td align="center">main</td>
    <td align="center">4fc004bf4f417b197f050b1db97b10ccbf021d4d</td>
    <td align="center">feat(production): update database connection string</td>
    <td align="center">---</td>
    <td align="center">Dec 5, 2025</td>
  </tr>
  <tr>
    <td align="center">main</td>
    <td align="center">7a0bb353233e1625c16ca1bcff53b032c7472b9f</td>
    <td align="center">fix(routes): implement GetAllRoutes endpoint and query handler</td>
    <td align="center">---</td>
    <td align="center">Dec 5, 2025</td>
  </tr>
  <tr>
    <td align="center">main</td>
    <td align="center">38ef7e1900430e9880b75ec0f8a38c3c30c0a30a</td>
    <td align="center">Merge branch 'main' of https://github.com/Aplicaciones-Moviles-Grupo/ChapaTuRutaBackend</td>
    <td align="center">---</td>
    <td align="center">Dec 5, 2025</td>
  </tr>

  <!-- Segundo repositorio añadido -->
  <tr>
    <td rowspan="3" align="center">https://github.com/Aplicaciones-Moviles-Grupo/ChapaTuRuta_FlutterApp/commits/feature/Connect/</td>
    <td align="center">feature/Connect</td>
    <td align="center">7eb3ad0bc7054dbf7ada90b5c8f6b821ec8c938c</td>
    <td align="center">feat: ultra commit</td>
    <td align="center">---</td>
    <td align="center">Dec 5, 2025</td>
  </tr>
  <tr>
    <td align="center">feature/Connect</td>
    <td align="center">858ff7bc5e503ac813bf63c99ab2c77c83da2ae3</td>
    <td align="center">Merge pull request #6 from Aplicaciones-Moviles-Grupo/develop</td>
    <td align="center">---</td>
    <td align="center">Nov 14, 2025</td>
  </tr>
    <tr>
    <td align="center">develop</td>
    <td align="center">28caf72b49ddc5db430a8f8b00cc5caa11f9376f</td>
    <td align="center">Merge pull request #5 from Aplicaciones-Moviles-Grupo/features/adrian</td>
    <td align="center">---</td>
    <td align="center">Nov 14, 2025</td>
  </tr>
